...
#include "stdafx.h"
#include "TestCubeIndex.h"
#include "DirectXCubeIndex.h"

CDirectXCubeIndex gclsDirectX;
                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_TESTCUBEINDEX, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_TESTCUBEINDEX));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_TESTCUBEINDEX));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_TESTCUBEINDEX);
