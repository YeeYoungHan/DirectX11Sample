 ...
 * @param y			마우스 Y 위치
 */
void CDirectXCubeIndex::OnMouseDown( HWND hWnd, int x, int y )
{
	m_sttMousePos.x = x;
	m_sttMousePos.y = y;
	m_bMouseDown = true;
 ...
 * @param y			마우스 Y 위치
 */
void CDirectXCubeIndex::OnMouseUp( int x, int y )
{
	ReleaseCapture();
	m_bMouseDown = false;
}
 ...
 * @param y			마우스 Y 위치
 */
void CDirectXCubeIndex::OnMouseMove( HWND hWnd, int x, int y )
{
	if( m_bMouseDown )
	{
