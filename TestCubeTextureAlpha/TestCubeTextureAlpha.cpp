// TestCubeTextureAlpha.cpp : 응용 프로그램에 대한 진입점을 정의합니다.
//

#include "stdafx.h"
#include "TestCubeTextureAlpha.h"
#include "DirectXCubeTextureAlpha.h"
#include "check.h"

CDirectXCubeTextureAlpha gclsDirectX;
                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_TESTCUBETEXTUREALPHA, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_TESTCUBETEXTUREALPHA));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_TESTCUBETEXTUREALPHA));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_TESTCUBETEXTUREALPHA);
